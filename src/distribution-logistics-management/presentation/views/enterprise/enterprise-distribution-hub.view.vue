<script setup>
const tabs = [
  { name: 'Repartos del Día', routeName: 'enterprise-distribution-day-deliveries' },
  { name: 'Mapa en Tiempo Real', routeName: 'enterprise-distribution-live-map' },
  { name: 'Supervisión de Rutas', routeName: 'enterprise-distribution-route-supervision' },
  { name: 'Historial de Repartos', routeName: 'enterprise-distribution-history' },
]
</script>
