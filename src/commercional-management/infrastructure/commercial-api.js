...
const dailySalesPath = '/api/v1/commercial-management/daily-sales'

/**
 * Infrastructure API service for Commercial Management.
 *
 * NOTE: the backend only exposes GET/POST on daily-sales and a
 * write-only POST on customer-debts (which requires an existing
